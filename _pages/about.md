...
I am an assistant professor with [Division of Integrative Systems and Design](https://isd.hkust.edu.hk/) in [Hong Kong University of Science and Technology (HKUST)](https://hkust.edu.hk/). My research areas include **mobile computing**, **AI enabled networking**, **multimodal learning**, **embodied AI**. I have published 100+ papers at the top international journal and conferences with total <a href='https://scholar.google.com/citations?user=xaTK57QAAAAJ'><img src="https://img.shields.io/endpoint?url={{ url | url_encode }}&logo=Google%20Scholar&labelColor=f6f6f6&color=9cf&style=flat&label=citations" class="original-size"></a>. 
